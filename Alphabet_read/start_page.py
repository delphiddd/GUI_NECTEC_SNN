...
ก็อปสไตล์เดียวกับ Tic Tac Toe เป๊ะ ต่างแค่ชื่อเกม
ใช้ร่วมกับ MainWindow ผ่าน signal `started(str)` และ method `reset()`
"""
...
HERO_TITLE = "Alphabet"
HERO_DESC  = ("เขียนตัวอักษรด้วยลายมือ แล้วให้ SNN กับ DNN แข่งกันอ่าน\n"
...
class StartPage(QWidget):
    ...
    def _build_ui(self):
        ...
        left_host = QWidget()
        # โปร่งใส ไม่งั้น background #f0f0f0 ของ MainWindow จะแผ่ทับ gradient
    ...
    def reset(self, message: str = DEFAULT_SUBTITLE):
        """กลับมาหน้านี้ — ล้างชื่อคนก่อน แล้วเคลียร์ช่องกรอก"""
